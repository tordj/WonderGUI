...
enum	WgEventType
{
	...
	WG_EVENT_MODAL_POINTER_ENTER,
	WG_EVENT_MODAL_POINTER_MOVE,
	WG_EVENT_MODAL_POINTER_EXIT,
	WG_EVENT_MODAL_BUTTON_PRESS,
	WG_EVENT_MODAL_BUTTON_REPEAT,
	WG_EVENT_MODAL_BUTTON_DRAG,
	WG_EVENT_MODAL_BUTTON_RELEASE,
