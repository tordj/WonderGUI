...
"    simd_float2   canvasDim;\n"
"    int        canvasYOfs;\n"
"    int        canvasYMul;\n"
"\n"
"    simd_float4 flatTint;\n"
"\n"
"    simd_int2     tintRectPos;\n"
"    simd_int2     tintRectSize;\n"
"\n"
...
"             constant simd_float4  *pExtras [[buffer(1)]],\n"
"             constant Uniform * pUniform[[buffer(2)]])\n"
"{\n"
"    PlotFragInput out;\n"
"\n"
"    float2 pos = (simd_float2) pVertices[vertexID].coord.xy;\n"
"\n"
"    simd_float2 canvasSize = pUniform->canvasDim;\n"
"    \n"
...
"    int     eOfs = pVertices[vertexID].extrasOfs;\n"
"\n"
"    simd_float4 srcDst = pExtras[eOfs];\n"
"    simd_float4 transform = pExtras[eOfs+1];\n"
"    simd_float2 src = srcDst.xy;\n"
"    simd_float2 dst = srcDst.zw;\n"
"\n"
...
"    int     eOfs = pVertices[vertexID].extrasOfs;\n"
"\n"
"    simd_float4 extras = pExtras[eOfs];\n"
"    simd_float4 extras2 = pExtras[eOfs+1];\n"
"\n"
