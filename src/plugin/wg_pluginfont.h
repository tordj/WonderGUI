...
#ifndef WG_PLUGINFONT_DOT_H
#define WG_PLUGINFONT_DOT_H
#pragma once
...
{
	class	PluginFont;
	typedef	StrongPtr<PluginFont>	PluginFont_p;
	typedef	WeakPtr<PluginFont>		PluginFont_wp;

	class PluginFont : public Font
	{
	public:
