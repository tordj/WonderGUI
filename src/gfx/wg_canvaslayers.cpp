...
namespace wg
{
	...
	CanvasLayers_p CanvasLayers::create(const Blueprint& bp)
	{
		...
		{
			GfxBase::handleError(ErrorSeverity::SilentFail, ErrorCode::InvalidParam, "Number of layers exceeds maximum", nullptr, &TYPEINFO, __func__, __FILE__, __LINE__);
			return nullptr;
		}
		...
		for (auto& layer : bp.layers)
		{
			...
			{
				GfxBase::handleError(ErrorSeverity::SilentFail, ErrorCode::InvalidParam, "Canvas layers can not be palette-based", nullptr, &TYPEINFO, __func__, __FILE__, __LINE__);
				return nullptr;
			}
		...
		{
			GfxBase::handleError(ErrorSeverity::Critical, ErrorCode::InvalidParam, "Default layer is out of bounds.", nullptr, &TYPEINFO, __func__, __FILE__, __LINE__);
			return nullptr;
		}
	...
	PixelFormat CanvasLayers::layerFormat(int layer) const
	{
		...
		{
			GfxBase::handleError(ErrorSeverity::SilentFail, ErrorCode::InvalidParam, "Layer does not exist.", nullptr, &TYPEINFO, __func__, __FILE__, __LINE__);
