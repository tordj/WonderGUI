...
namespace wg
{
	...
	bool Waveform::setRenderSegments(int segments)
	{
	...
	HiColor Waveform::color(int segment) const
	{
	...
	Gradient Waveform::gradient(int segment) const
	{
	...
	bool Waveform::_validateBlueprint(const Blueprint& bp)
	{
