...
#ifndef WG_WAVEFORM_DOT_H
#define WG_WAVEFORM_DOT_H
#pragma once
...
namespace wg
{
	...
	protected:
		...
		Waveform( const Blueprint& bp ) : m_size(bp.size), m_nbSegments(bp.segments), m_nbRenderSegments(bp.segments) {};
		virtual ~Waveform() {};
