...
SoftWaveform_p SoftWaveform::create( const Waveform::Blueprint& blueprint, WaveOrigo origo, float * pSamples, int edges, int edgePitch, int samplePitch)
{
	if( !_validateBlueprint(blueprint) )
		return nullptr;
...
SoftWaveform_p SoftWaveform::create( const Waveform::Blueprint& blueprint, WaveOrigo origo, spx * pSamples, int edges, int edgePitch, int samplePitch)
{
	if( !_validateBlueprint(blueprint) )
		return nullptr;
