...
namespace wg
{
	...
	class GfxStreamDevice;
	typedef	StrongPtr<GfxStreamDevice> GfxStreamDevice_p;
	typedef	WeakPtr<GfxStreamDevice>	GfxStreamDevice_wp;

	class GfxStreamDevice : public GfxDevice
	{
	public:

		//.____ Creation __________________________________________

		static GfxStreamDevice_p	create( GfxStreamEncoder * pEncoder );
