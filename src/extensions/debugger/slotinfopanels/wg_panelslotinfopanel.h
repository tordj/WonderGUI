...
namespace wg
{
	...
	public:
		...
		static PanelSlotInfoPanel_p		create( const Blueprint& blueprint, StaticSlot * pStaticSlot) { return PanelSlotInfoPanel_p(new PanelSlotInfoPanel(blueprint, pStaticSlot) ); }
	...
	protected:
		PanelSlotInfoPanel(const Blueprint& blueprint, StaticSlot * pStaticSlot );
		~PanelSlotInfoPanel() {}
	};
