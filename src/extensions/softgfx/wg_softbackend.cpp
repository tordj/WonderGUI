...
namespace wg
{
	...
	const int16_t SoftBackend::s_channel_5_linear[32] = { 4096 * 0 / 31, 4096 * 1 / 31, 4096 * 2 / 31, 4096 * 3 / 31, 4096 * 4 / 31, 4096 * 5 / 31, 4096 * 6 / 31, 4096 * 7 / 31, 4096 * 8 / 31, 4096 * 9 / 31, 4096 * 10 / 31, 4096 * 11 / 31, 4096 * 12 / 31, 4096 * 13 / 31, 4096 * 14 / 31, 4096 * 15 / 31,
	...
	const int16_t SoftBackend::s_channel_6_linear[64] = { 4096 * 0 / 63, 4096 * 1 / 63, 4096 * 2 / 63, 4096 * 3 / 63, 4096 * 4 / 63, 4096 * 5 / 63, 4096 * 6 / 63, 4096 * 7 / 63, 4096 * 8 / 63, 4096 * 9 / 63, 4096 * 10 / 63, 4096 * 11 / 63, 4096 * 12 / 63, 4096 * 13 / 63, 4096 * 14 / 63, 4096 * 15 / 63,
	...
	const int16_t SoftBackend::s_channel_5_sRGB[32] = { 0, 2, 10, 24, 45, 74, 110, 155, 208, 270, 340, 419, 508, 605, 713, 829,
														956, 1092, 1239, 1395, 1562, 1739, 1926, 2124, 2333, 2552, 2782, 3022, 3274, 3537, 3811, 4096 };

	const int16_t SoftBackend::s_channel_6_sRGB[64] = { 0, 0, 2, 5, 10, 16, 23, 33, 44, 57, 71, 88, 107, 127, 150, 174,
