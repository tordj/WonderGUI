...
bool wg::addExtraSoftKernelsForRGB555BECanvas( SoftGfxDevice * pDevice )
{
	...
	pDevice->setStraightBlitKernel( PixelFormat::RGB_555_bigendian, SampleMethod::Nearest, SoftGfxDevice::EdgeOp::None, TintMode::None, BlendMode::Replace, PixelFormat::RGB_555_bigendian, _straight_blit_rgb555bigendian_to_same_notint_noblend );

	
	pDevice->setStraightBlitKernel( PixelFormat::Index_8_linear, SampleMethod::Nearest, SoftGfxDevice::EdgeOp::None, TintMode::None, BlendMode::Replace, PixelFormat::RGB_555_bigendian, _straight_blit_index8linear_to_rgb555bigendian_notint_noblend );

	pDevice->setStraightBlitKernel( PixelFormat::Index_8_linear, SampleMethod::Nearest, SoftGfxDevice::EdgeOp::None, TintMode::None, BlendMode::Blend, PixelFormat::RGB_555_bigendian, _straight_blit_index8linear_to_rgb555bigendian_notint_blend );
	
	
	pDevice->setStraightBlitKernel( PixelFormat::Alpha_8, SampleMethod::Nearest, SoftGfxDevice::EdgeOp::None, TintMode::None, BlendMode::Blend, PixelFormat::RGB_555_bigendian, _straight_blit_alpha8_to_rgb555bigendian_notint_blend );

	pDevice->setStraightBlitKernel( PixelFormat::Alpha_8, SampleMethod::Nearest, SoftGfxDevice::EdgeOp::None, TintMode::Flat, BlendMode::Blend, PixelFormat::RGB_555_bigendian, _straight_blit_alpha8_to_rgb555bigendian_flattint_blend );

	
	pDevice->setStraightBlitKernel( PixelFormat::Alpha_8, SampleMethod::Nearest, SoftGfxDevice::EdgeOp::None, TintMode::None, BlendMode::BlendFixedColor, PixelFormat::RGB_555_bigendian, _straight_blit_alpha8_to_rgb555bigendian_no_or_flat_tint_fixedblend );

	pDevice->setStraightBlitKernel( PixelFormat::Alpha_8, SampleMethod::Nearest, SoftGfxDevice::EdgeOp::None, TintMode::Flat, BlendMode::BlendFixedColor, PixelFormat::RGB_555_bigendian, _straight_blit_alpha8_to_rgb555bigendian_no_or_flat_tint_fixedblend );

	
	pDevice->setStraightBlitKernel( PixelFormat::BGRA_8_linear, SampleMethod::Nearest, SoftGfxDevice::EdgeOp::None, TintMode::None, BlendMode::Replace, PixelFormat::RGB_555_bigendian, _straight_blit_bgrxa8linear_to_rgb555bigendian_notint_noblend );

	pDevice->setStraightBlitKernel( PixelFormat::BGRX_8_linear, SampleMethod::Nearest, SoftGfxDevice::EdgeOp::None, TintMode::None, BlendMode::Replace, PixelFormat::RGB_555_bigendian, _straight_blit_bgrxa8linear_to_rgb555bigendian_notint_noblend );
	
	pDevice->setStraightBlitKernel( PixelFormat::BGRA_8_linear, SampleMethod::Nearest, SoftGfxDevice::EdgeOp::None, TintMode::None, BlendMode::Blend, PixelFormat::RGB_555_bigendian, _straight_blit_bgra8linear_to_rgb555bigendian_notint_blend );
