...
namespace wg
{
	const TypeInfo StreamTrimEncoder::TYPEINFO = { "StreamTrimEncoder", &Object::TYPEINFO };
	...
	StreamTrimEncoder::~StreamTrimEncoder()
	{
	}
	...
	const TypeInfo& StreamTrimEncoder::typeInfo(void) const
	{
		return TYPEINFO;
	}
	...
	void StreamTrimEncoder::_beginChunk(GfxStream::Header header)
	{
		switch( header.type )
		{
	...
	void StreamTrimEncoder::_processScopes()
	{
		if( m_scopes.size() < 2 )
			return;
	...
	void StreamTrimEncoder::_writeScopeToOutput( Scope * pScope )
	{
	...
	void StreamTrimEncoder::_optimizeClipLists( Scope * pScope )
	{
	...
	StreamTrimEncoder::ClipListScopeResult StreamTrimEncoder::_processClipListScope( ChunkInfo * pScope, RectSPX * pClipRects, int nClipRects )
	{
	...
	bool StreamTrimEncoder::_isRenderingChunk(GfxChunkId chunkType)
	{
	...
	bool StreamTrimEncoder::_compareClipLists(RectSPX * pList1, int sizeList1, RectSPX * pList2, int sizeList2 )
	{
	...
	bool StreamTrimEncoder::_processSetClipList( ChunkInfo * pScope, RectSPX * pCurrRects, int nCurrRects, RectSPX * pMyRects, int nMyRects)
	{
