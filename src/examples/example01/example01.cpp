...
int main ( int argc, char** argv )
{
...

	{
		...
		pButton->setSkin(BlockSkin::create( { .blockAxis = Axis::X, .frame = Border(3,3,3,3), .states = { StateEnum::Hovered, {}, StateEnum::Pressed, {}, StateEnum::Disabled, {} }, .surface = pButtonSurface }));
