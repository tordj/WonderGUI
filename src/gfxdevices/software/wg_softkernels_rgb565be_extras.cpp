...
bool wg::addExtraSoftKernelsForRGB565BECanvas( SoftGfxDevice * pDevice )
{
	...
	pDevice->setStraightBlitKernel( PixelFormat::BGRX_8_linear, SoftGfxDevice::EdgeOp::None, TintMode::None, BlendMode::Replace, PixelFormat::RGB_565_bigendian, _straight_blit_bgrxa8linear_to_rgb565bigendian_notint_noblend );
	
	pDevice->setStraightBlitKernel( PixelFormat::BGRA_8_linear, SoftGfxDevice::EdgeOp::None, TintMode::None, BlendMode::Blend, PixelFormat::RGB_565_bigendian, _straight_blit_bgra8linear_to_rgb565bigendian_notint_blend );
