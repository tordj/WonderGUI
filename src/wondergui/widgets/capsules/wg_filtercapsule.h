...
=========================================================================*/
#ifndef WG_FILTERCAPSULE_DOT_H
#define WG_FILTERCAPSULE_DOT_H
#pragma once
...
namespace wg
{
	...
	class FilterCapsule;
	typedef	StrongPtr<FilterCapsule>	FilterCapsule_p;
	typedef	WeakPtr<FilterCapsule>		FilterCapsule_wp;


	//____ FilterCapsule ______________________________________________________
	/**
	* @brief	A widget that provides a separate canvas for its descendants.
	*
	* The FilterCapsule provides a separate canvas for its descendants into which they
	...
	*/
	...
	class FilterCapsule : public Capsule
	{
	public:
		...
		static FilterCapsule_p	create() { return FilterCapsule_p(new FilterCapsule()); }
		static FilterCapsule_p	create( const Blueprint& bp ) { return FilterCapsule_p(new FilterCapsule(bp)); }
	...
	protected:
		...
		template<class BP> FilterCapsule(const BP& bp) : Capsule(bp)
		{
		...
		Surface_p			m_pCanvas;
        Surface_p			m_pStateCanvas;
        Surface_p			m_pTmpCanvas;
