...
*/
	...
	bool GfxDevice::_beginCanvasUpdate(const RectSPX& canvas, Surface * pCanvas, int nUpdateRects, const RectSPX* pUpdateRects, CanvasLayers * pCanvasLayers, int startLayer )
	{
		SizeSPX sz = canvas.size()*64;
