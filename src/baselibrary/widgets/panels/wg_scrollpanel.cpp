...
namespace wg
{
	...
	*/
	...
	bool ScrollPanel::setSizeConstraints(SizeConstraint width, SizeConstraint height)
	{
		...
		{
			Base::handleError(ErrorLevel::SilentError, ErrorCode::InvalidParam, "Only one dimension can be constrained to Equal/LessOrEqual", this, &TYPEINFO, __func__, __FILE__, __LINE__);
			return false;
		}
