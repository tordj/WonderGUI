...
namespace wg 
{
	...
	public:
		...
		MenuEntry( int id, const String& text, const String& helpText, const Skin_p& pIcon, uint16_t navKey,
			ModifierKeys accelModif = MODKEY_NONE, uint16_t accelKey = 0, const String& accelText = String() );
		virtual ~MenuEntry();
		...
		void 	setAccelModifier(ModifierKeys accelModif);
		...
		inline ModifierKeys	getAccelModif()	{ return m_accelModif; }
