...
Uint32 WgText::getSoftLineWidth( Uint32 line ) const
{
	...
	return WgTextTool::lineWidthSoft( m_pProp, m_mode, getSoftLineText(line) );
}
...
Uint32 WgText::getSoftLineWidthPart( Uint32 _line, Uint32 startCol, Uint32 nCol ) const
{
	...
	return WgTextTool::lineWidthPartSoft( m_pProp, m_mode, pLine->pText, nCol );
}
...
Uint32 WgText::getLineWidth( Uint32 line ) const
{
	...
	return WgTextTool::lineWidth( m_pProp, m_mode, getLineText(line) );
}
...
Uint32 WgText::getLineWidthPart( Uint32 _line, Uint32 startCol, Uint32 nCol ) const
{
	...
	return WgTextTool::lineWidthPart( m_pProp, m_mode, pLine->pText, nCol );
}
...
WgChar * WgText::beginChange( Uint32 line, Uint32 col, Uint32 addChar, Uint32 delChar,
